...
let repo repo_root = OpamRepositoryRoot.Dir.subfile repo_root "repo" |> OpamFile.make

let packages_dir repo_root = OpamRepositoryRoot.Dir.subdir repo_root "packages"
